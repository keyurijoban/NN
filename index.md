...
* Keras api makes the code writting more intuitive and abstracts away some of the unnecessary details from the user
 ...
 * Layers: Helps define different types of layers, fully connected, convolutional, pooling and recurrent
...
--- .class #id
## mxnet: Coding the networks
* Mxnet has an R api and currently (May 2017), this is one of the few frameworks that support deep learning in R
* At an api level mxnet is very similar to Keras, the emphasis is on creating higher level abstractions
* As of May 2017, mxnet supports CNNs, RNNs and a host of other popular architectures
...
```r
library(mxnet)
# symbolically representing data/input layer
...
....
# adding last layer
fc_n<-mx.symbol.FullyConnected(act_n-1,num_hidden=20)
softmax<-mx.symbol.SoftmaxOutput(fc_n,act_type='softmax')
